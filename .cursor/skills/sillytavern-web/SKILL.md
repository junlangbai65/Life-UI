...
/tavernlike 为我的 React 项目添加 SillyTavern
Integrate SillyTavern into this project
Add character cards and world info
```

> 上游仓库：[ariespo/tavernlike](https://github.com/ariespo/tavernlike)。本仓库内路径 `.cursor/skills/sillytavern-web/`；同步说明见 `UPSTREAM.md`。
